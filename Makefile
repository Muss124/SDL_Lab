...
# Project:  test1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile test1.pro -spec linux-g++ CONFIG+=debug CONFIG-=qml_debug
#############################################################################
...
INCPATH       = -I. -I/usr/local/lib -isystem /usr/include/qt -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = test11.0.0
DISTDIR = /home/crazyonionman/test1/.tmp/test11.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lSDL -lSDL_ttf -lSDL_draw -L/usr/local/lib /usr/lib/libQt5Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: test1.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
